...
public class UserList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query.whereNotEqualTo("username", ParseUser.getCurrentUser().getUsername());  // except the current user.
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && resultCode == RESULT_OK && data != null) {
            ...
            try {
                ...
                byte[] byteArray = stream.toByteArray(); // any type of file can be stored in bytearray
                ParseFile file = new ParseFile("image.png", byteArray);

                ParseObject object = new ParseObject("images");
                object.put("username", ParseUser.getCurrentUser().getUsername()); // save to parse
